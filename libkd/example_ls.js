...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'example_ls.data';
      var REMOTE_PACKAGE_BASE = 'example_ls.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_example_ls.data');

      };
      Module['addRunDependency']('datafile_example_ls.data');
...
var wasmBinaryFile;
  wasmBinaryFile = 'example_ls.wasm';
